UPDATE gbua_cgdb.PageReviewsTranslation SET LangID = 1, FormTranslator = '<div class="col-12 text-center mb-5">
...
UPDATE gbua_cgdb.PageReviewsTranslation SET LangID = 2, FormTranslator = '<div class="col-12 text-center mb-5">
...
';
UPDATE gbua_cgdb.PageReviewsTranslation SET LangID = 3, FormTranslator = '';
UPDATE gbua_cgdb.PageReviewsTranslation SET LangID = 4, FormTranslator = '<div class="col-12 text-center mb-5">
