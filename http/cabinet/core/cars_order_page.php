...
Class cars_order_page
{
    ...
    //конструктор
    function cars_order_page($mysqli, $CardID)
    {
        $this -> CardID = $CardID;
        $this->mysqli = $mysqli;
    ...
    function generate()
    {
        ...
        $this -> GetMain_order_car_pageTemplete();
        ...
        require_once ($_SERVER["DOCUMENT_ROOT"].'/cabinet/core/admin/car.php');
        $card = new car($this->mysqli, $this->CardID);
    ...
    private function GetMain_order_car_pageTemplete()
    {
        $_file_path = $_SERVER["DOCUMENT_ROOT"] . '/cabinet/templete/order_car_page.html';
        if (file_exists($_file_path)) {
