...
Class booking_details_page
{
    ...
    function getBookingData(){
        ...
        require_once ($_SERVER["DOCUMENT_ROOT"].'/cabinet/core/bookingcars.php');
    ...
    function generate()
    {
        ...
        $this -> templete_current_page = str_replace('{CardPrimaryTitle}', $this->Booking->Car, $this -> templete_current_page);
...
// d
    ...
    private function GetPageListTemplete(){
        $_file_path = $_SERVER["DOCUMENT_ROOT"].'/cabinet/templete/operator/booking_car_detail_page.html';
