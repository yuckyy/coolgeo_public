...
Class booking_list_page
{
    ...
    //конструктор
    function booking_list_page($mysqli, $Page)
    {
        $this->mysqli = $mysqli;
        ...
        $MySQLiQuerry = $this -> mysqli->prepare("
                SELECT Value
                    FROM Settings
                    where `Key` = 'Operator_BookingList_RowsOnPage';
            ");
    ...
    function generate()
    {
        ...
        $this->templete_current_page = str_replace('{Bookings-Paginator}', $paginator, $this->templete_current_page);
    ...
    function getPaginator(){
        ...
        $pagination = new pagination($CountPages,$this->Page, '/cabinet/page/operator/booking_list.php?page={page}');
    ...
    private function GetPageListTemplete(){
        $_file_path = $_SERVER["DOCUMENT_ROOT"].'/cabinet/templete/operator/booking_list_page.html';
