...
Class booking
{
    ...
    function getBooking(){
        ...
        SELECT b.id, b.name, b.email, b.country, b.phone, b.description, b.time, b.startdate, b.finaldate, b.column1, b.driver, b.starttime, b.finaltime, b.BookingStatus, b.TotalAmount
...
var_dump($result);
        ...
        $this->DateBooking = $this -> getDateFromDB($result[0]['startdate']);
        $this->DateBookingEnd = $this -> getDateFromDB($result[0]['finaldate']);
        // $this->CardID = $result[0]['CardID'];
        $this->BookingStatusID = $result[0]['BookingStatus'];
        ...
        $this->Car = $result[0]['column1'];
        $this->UserName = $result[0]['name'];
        $this->UserPhone = $result[0]['phone'];
