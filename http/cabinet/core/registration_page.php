...
Class registration_page
{
    ...
    //конструктор
    function registration_page($mysqli)
    {
        $this->mysqli = $mysqli;
    }
    ...
    function generate()
    {
        ...
        $headers = '
            <script src="/cabinet/js/registration_page.js"></script>
            <link href="/cabinet/css/registration_page.css" rel="stylesheet">  
    ...
    private function GetLogin_formTemplete(){
        $_file_path = $_SERVER["DOCUMENT_ROOT"].'/cabinet/templete/registration_page.html';
        if (file_exists($_file_path))
        {
